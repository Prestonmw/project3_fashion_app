      ...
      return (
        <div className="Home">
          ...
          <div className="container">
            <div className="row">
              <div className="col-6">
                <Example title="Men's" subtitle="" text="Hello again" buttonText="Click Me" btnhref="/mens" image="https://cdn.shopify.com/s/files/1/0981/8178/files/editor-blue-oxford-freelancer-utility-shirt-left-hero_1024x1024.jpg?13256324731859498008" />
              </div>
              <div className="col-6">
